 ...
 */
NGL_EXPORT
@interface NGLHeatmapStyleLayer : NGLVectorStyleLayer
...
*/
@property (nonatomic) NGLTransition heatmapIntensityTransition;
...
*/
@property (nonatomic) NGLTransition heatmapOpacityTransition;
...
*/
@property (nonatomic) NGLTransition heatmapRadiusTransition;
