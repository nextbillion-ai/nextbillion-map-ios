...
typedef NS_ENUM(NSUInteger, NGLLineTranslationAnchor) {
     ...
     */
    NGLLineTranslationAnchorMap,
    /**
     The line is translated relative to the viewport.
     */
    NGLLineTranslationAnchorViewport,
};
 ...
 */
NGL_EXPORT
@interface NGLLineStyleLayer : NGLVectorStyleLayer
...
*/
@property (nonatomic) NGLTransition lineBlurTransition;
...
*/
@property (nonatomic) NGLTransition lineColorTransition;
...
*/
@property (nonatomic) NGLTransition lineDashPatternTransition;
...
*/
@property (nonatomic) NGLTransition lineGapWidthTransition;
...
*/
@property (nonatomic) NGLTransition lineOffsetTransition;
...
*/
@property (nonatomic) NGLTransition lineOpacityTransition;
...
*/
@property (nonatomic) NGLTransition linePatternTransition;
...
*/
@property (nonatomic) NGLTransition lineTranslationTransition;
 ...
 * Constant `NGLLineTranslationAnchor` values
 * Any of the following constant string values:
...
*/
@property (nonatomic) NGLTransition lineWidthTransition;
...
/**
 Creates a new value object containing the given `NGLLineJoin` enumeration.
...
/**
 Creates a new value object containing the given `NGLLineTranslationAnchor` enumeration.
