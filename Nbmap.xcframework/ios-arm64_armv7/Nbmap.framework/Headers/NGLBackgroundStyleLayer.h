 ...
 */
NGL_EXPORT
@interface NGLBackgroundStyleLayer : NGLStyleLayer
...
*/
@property (nonatomic) NGLTransition backgroundColorTransition;
...
*/
@property (nonatomic) NGLTransition backgroundOpacityTransition;
...
*/
@property (nonatomic) NGLTransition backgroundPatternTransition;
