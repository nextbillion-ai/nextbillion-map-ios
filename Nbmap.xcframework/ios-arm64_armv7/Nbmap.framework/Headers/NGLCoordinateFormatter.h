...
/**
 The `NGLCoordinateFormatter` class provides properly formatted descriptions of
 ...
 */
NGL_EXPORT
@interface NGLCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the `NGLCoordinateFormatter` class.
 */
