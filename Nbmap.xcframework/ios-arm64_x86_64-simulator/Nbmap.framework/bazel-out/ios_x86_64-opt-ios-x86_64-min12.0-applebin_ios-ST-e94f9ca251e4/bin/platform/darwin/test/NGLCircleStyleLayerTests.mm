...
@interface NGLCircleLayerTests : NGLStyleLayerTests
@end

@implementation NGLCircleLayerTests
...
- (void)testPredicates {
    ...
    NGLCircleStyleLayer *layer = [[NGLCircleStyleLayer alloc] initWithIdentifier:@"layerID" source:source];
...
- (void)testProperties {
    ...
    auto rawLayer = static_cast<nbgl::style::CircleLayer*>(layer.rawLayer);
    ...
    // circle-blur
    {
        ...
        NGLTransition circleBlurTransition = layer.circleBlurTransition;
    ...
    // circle-color
    {
        ...
        NGLTransition circleColorTransition = layer.circleColorTransition;
    ...
    // circle-opacity
    {
        ...
        NGLTransition circleOpacityTransition = layer.circleOpacityTransition;
    ...
    // circle-pitch-alignment
    {
        ...
        nbgl::style::PropertyValue<nbgl::style::AlignmentType> propertyValue = { nbgl::style::AlignmentType::Viewport };
        ...
        XCTAssertThrowsSpecificNamed(layer.circlePitchAlignment = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    ...
    // circle-radius
    {
        ...
        NGLTransition circleRadiusTransition = layer.circleRadiusTransition;
    ...
    // circle-pitch-scale
    {
        ...
        nbgl::style::PropertyValue<nbgl::style::CirclePitchScaleType> propertyValue = { nbgl::style::CirclePitchScaleType::Viewport };
        ...
        {
            using namespace nbgl::style::expression::dsl;
            propertyValue = nbgl::style::PropertyExpression<nbgl::style::CirclePitchScaleType>(
                step(zoom(), literal("viewport"), 18.0, literal("viewport"))
            );
        }
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleScaleAlignment = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"ngl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"ngl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleScaleAlignment = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
    ...
    // circle-stroke-color
    {
        ...
        NGLTransition circleStrokeColorTransition = layer.circleStrokeColorTransition;
    ...
    // circle-stroke-opacity
    {
        ...
        NGLTransition circleStrokeOpacityTransition = layer.circleStrokeOpacityTransition;
    ...
    // circle-stroke-width
    {
        ...
        NGLTransition circleStrokeWidthTransition = layer.circleStrokeWidthTransition;
    ...
    // circle-translate
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleTranslation = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"ngl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"ngl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleTranslation = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
    ...
    // circle-translate-anchor
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"ngl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"ngl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"NGLCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
...
- (void)testValueAdditions {
    XCTAssertEqual([NSValue valueWithNGLCirclePitchAlignment:NGLCirclePitchAlignmentMap].NGLCirclePitchAlignmentValue, NGLCirclePitchAlignmentMap);
    XCTAssertEqual([NSValue valueWithNGLCirclePitchAlignment:NGLCirclePitchAlignmentViewport].NGLCirclePitchAlignmentValue, NGLCirclePitchAlignmentViewport);
    XCTAssertEqual([NSValue valueWithNGLCircleScaleAlignment:NGLCircleScaleAlignmentMap].NGLCircleScaleAlignmentValue, NGLCircleScaleAlignmentMap);
    XCTAssertEqual([NSValue valueWithNGLCircleScaleAlignment:NGLCircleScaleAlignmentViewport].NGLCircleScaleAlignmentValue, NGLCircleScaleAlignmentViewport);
    XCTAssertEqual([NSValue valueWithNGLCircleTranslationAnchor:NGLCircleTranslationAnchorMap].NGLCircleTranslationAnchorValue, NGLCircleTranslationAnchorMap);
    XCTAssertEqual([NSValue valueWithNGLCircleTranslationAnchor:NGLCircleTranslationAnchorViewport].NGLCircleTranslationAnchorValue, NGLCircleTranslationAnchorViewport);
}
