...
@interface NGLMapView (IBAdditions)
...
// inspectables declared in NGLMapView.h are always sorted before those in
// NGLMapView+IBAdditions.h, due to ASCII sort order.
