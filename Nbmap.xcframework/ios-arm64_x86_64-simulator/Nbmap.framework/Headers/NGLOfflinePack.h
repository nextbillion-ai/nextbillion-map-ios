...
/**
 ...
 `NGLOfflinePackStateUnknown` by default. To request the pack’s status, use the
...
/**
 ...
 set to `NGLOfflinePackStateUnknown`, observe KVO change notifications on this
