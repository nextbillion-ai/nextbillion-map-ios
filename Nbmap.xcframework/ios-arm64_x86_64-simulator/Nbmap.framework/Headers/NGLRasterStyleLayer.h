...
typedef NS_ENUM(NSUInteger, NGLRasterResamplingMode) {
     ...
     */
    NGLRasterResamplingModeNearest,
};
 ...
 */
NGL_EXPORT
@interface NGLRasterStyleLayer : NGLForegroundStyleLayer
...
*/
@property (nonatomic) NGLTransition maximumRasterBrightnessTransition;
...
*/
@property (nonatomic) NGLTransition minimumRasterBrightnessTransition;
...
*/
@property (nonatomic) NGLTransition rasterHueRotationTransition;
...
*/
@property (nonatomic) NGLTransition rasterOpacityTransition;
 ...
 * Constant `NGLRasterResamplingMode` values
...
*/
@property (nonatomic) NGLTransition rasterSaturationTransition;
