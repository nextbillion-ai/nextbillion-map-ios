...
/**
 ...
 deltas.
 */
NS_INLINE NGLCoordinateSpan NGLCoordinateSpanMake(CLLocationDegrees latitudeDelta,
                                                  CLLocationDegrees longitudeDelta) {
 ...
 */
NS_INLINE BOOL NGLCoordinateSpanEqualToCoordinateSpan(NGLCoordinateSpan span1,
                                                      NGLCoordinateSpan span2) {
...
/**
 ...
 ``NGLCoordinateQuad`` differs from ``NGLCoordinateQuad`` in that it allows
 ...
 */
NS_INLINE NGLCoordinateBounds NGLCoordinateBoundsMake(CLLocationCoordinate2D sw,
                                                      CLLocationCoordinate2D ne) {
 ...
 */
NS_INLINE NGLCoordinateQuad NGLCoordinateQuadMake(CLLocationCoordinate2D topLeft,
                                                  CLLocationCoordinate2D bottomLeft,
                                                  CLLocationCoordinate2D bottomRight,
                                                  CLLocationCoordinate2D topRight) {
...
/**
 Creates a new ``NGLCoordinateQuad`` structure from the given ``NGLCoordinateQuad``.
...
NS_INLINE BOOL NGLCoordinateBoundsEqualToCoordinateBounds(NGLCoordinateBounds bounds1,
                                                          NGLCoordinateBounds bounds2) {
  return (
...
NS_INLINE BOOL NGLCoordinateBoundsIntersectsCoordinateBounds(NGLCoordinateBounds bounds1,
                                                             NGLCoordinateBounds bounds2) {
 ...
 */
NS_INLINE BOOL NGLCoordinateInCoordinateBounds(CLLocationCoordinate2D coordinate,
                                               NGLCoordinateBounds bounds) {
 ...
 */
NS_INLINE NGLCoordinateBounds NGLCoordinateBoundsOffset(NGLCoordinateBounds bounds,
                                                        NGLCoordinateSpan offset) {
...
NS_INLINE CLLocationDegrees NGLDegreesFromRadians(CGFloat radians) { return radians * 180 / M_PI; }

/** Returns Mercator projection of a WGS84 coordinate at the specified zoom level. */
FOUNDATION_EXTERN NGL_EXPORT NGLMapPoint NGLMapPointForCoordinate(CLLocationCoordinate2D coordinate,
                                                                  double zoomLevel);
...
FOUNDATION_EXTERN NGL_EXPORT CLLocationDistance NGLAltitudeForZoomLevel(double zoomLevel,
                                                                        CGFloat pitch,
...
FOUNDATION_EXTERN NGL_EXPORT double NGLZoomLevelForAltitude(CLLocationDistance altitude,
                                                            CGFloat pitch,
                                                            CLLocationDegrees latitude,
                                                            CGSize size);
