...
/** Defines the area spanned by an `NGLCoordinateBounds`. */
typedef struct __attribute__((objc_boxable)) NGLCoordinateSpan {
    /** Latitudes spanned by an `NGLCoordinateBounds`. */
    CLLocationDegrees latitudeDelta;
    /** Longitudes spanned by an `NGLCoordinateBounds`. */
    CLLocationDegrees longitudeDelta;
} NGLCoordinateSpan;

/* Defines a point on the map in Mercator projection for a specific zoom level. */
typedef struct __attribute__((objc_boxable)) NGLMapPoint {
...
/**
 Creates a new `NGLCoordinateSpan` from the given latitudinal and longitudinal
 deltas.
 */
NS_INLINE NGLCoordinateSpan NGLCoordinateSpanMake(CLLocationDegrees latitudeDelta, CLLocationDegrees longitudeDelta) {
    NGLCoordinateSpan span;
...
/**
 Creates a new `NGLMapPoint` from the given X and Y coordinates, and zoom level.
 */
NS_INLINE NGLMapPoint NGLMapPointMake(CGFloat x, CGFloat y, CGFloat zoomLevel) {
    NGLMapPoint point;
    point.x = x;
    point.y = y;
 ...
 */
NS_INLINE BOOL NGLCoordinateSpanEqualToCoordinateSpan(NGLCoordinateSpan span1, NGLCoordinateSpan span2) {
...
FOUNDATION_EXTERN NGL_EXPORT const NGLCoordinateSpan NGLCoordinateSpanZero;

/** A rectangular area as measured on a two-dimensional map projection. */
typedef struct __attribute__((objc_boxable)) NGLCoordinateBounds {
...
/** 
 ...
 `NGLCoordinateQuad` differs from `NGLCoordinateBounds` in that it allows
 ...
 */
typedef struct NGLCoordinateQuad {
...
/**
 Creates a new `NGLCoordinateBounds` structure from the given southwest and
 northeast coordinates.
 */
NS_INLINE NGLCoordinateBounds NGLCoordinateBoundsMake(CLLocationCoordinate2D sw, CLLocationCoordinate2D ne) {
    NGLCoordinateBounds bounds;
    bounds.sw = sw;
    bounds.ne = ne;
    return bounds;
}
...
/**
 Creates a new `NGLCoordinateQuad` structure from the given top left,
  bottom left, bottom right, and top right coordinates.
 */
NS_INLINE NGLCoordinateQuad NGLCoordinateQuadMake(CLLocationCoordinate2D topLeft, CLLocationCoordinate2D bottomLeft, CLLocationCoordinate2D bottomRight, CLLocationCoordinate2D topRight) {
    NGLCoordinateQuad quad;
...
/**
 Creates a new `NGLCoordinateQuad` structure from the given `NGLCoordinateBounds`.
 The returned quad uses the bounds' northeast coordinate as the top right, and the
  southwest coordinate at the bottom left.
 */
NS_INLINE NGLCoordinateQuad NGLCoordinateQuadFromCoordinateBounds(NGLCoordinateBounds bounds) {
    NGLCoordinateQuad quad;
...
NS_INLINE BOOL NGLCoordinateBoundsEqualToCoordinateBounds(NGLCoordinateBounds bounds1, NGLCoordinateBounds bounds2) {
...
NS_INLINE BOOL NGLCoordinateBoundsIntersectsCoordinateBounds(NGLCoordinateBounds bounds1, NGLCoordinateBounds bounds2) {
...
/**
 ...
 `NGLCoordinateInCoordinateBounds` to determine if a point is within, or
 intersects, a given bounding box.
 */
NS_INLINE BOOL NGLCoordinateInCoordinateBounds(CLLocationCoordinate2D coordinate, NGLCoordinateBounds bounds) {
...
NS_INLINE NGLCoordinateSpan NGLCoordinateBoundsGetCoordinateSpan(NGLCoordinateBounds bounds) {
    return NGLCoordinateSpanMake(bounds.ne.latitude - bounds.sw.latitude,
 ...
 */
NS_INLINE NGLCoordinateBounds NGLCoordinateBoundsOffset(NGLCoordinateBounds bounds, NGLCoordinateSpan offset) {
    NGLCoordinateBounds offsetBounds = bounds;
 ...
 */
NS_INLINE BOOL NGLCoordinateBoundsIsEmpty(NGLCoordinateBounds bounds) {
    NGLCoordinateSpan span = NGLCoordinateBoundsGetCoordinateSpan(bounds);
    return span.latitudeDelta == 0 || span.longitudeDelta == 0;
}

/** Returns a formatted string for the given coordinate bounds. */
NS_INLINE NSString *NGLStringFromCoordinateBounds(NGLCoordinateBounds bounds) {
...
NS_INLINE NSString *NGLStringFromCoordinateQuad(NGLCoordinateQuad quad) {
...
NS_INLINE CGFloat NGLRadiansFromDegrees(CLLocationDegrees degrees) {
    return (CGFloat)(degrees * M_PI) / 180;
}

/** Returns degrees, converted from radians. */
NS_INLINE CLLocationDegrees NGLDegreesFromRadians(CGFloat radians) {
    return radians * 180 / M_PI;
}

/** Returns Mercator projection of a WGS84 coordinate at the specified zoom level. */
FOUNDATION_EXTERN NGL_EXPORT NGLMapPoint NGLMapPointForCoordinate(CLLocationCoordinate2D coordinate, double zoomLevel);
...
FOUNDATION_EXTERN NGL_EXPORT CLLocationDistance NGLAltitudeForZoomLevel(double zoomLevel, CGFloat pitch, CLLocationDegrees latitude, CGSize size);
...
FOUNDATION_EXTERN NGL_EXPORT double NGLZoomLevelForAltitude(CLLocationDistance altitude, CGFloat pitch, CLLocationDegrees latitude, CGSize size);
