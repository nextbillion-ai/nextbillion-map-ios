...
/**
 ...
 ``NGLVectorTileSource``’s point shapes collectively using an ``NGLVectorTileSource`` or
 ...
 annotation’s ``NGLShape/title`` and ``NGLShape/title`` properties define the
 ...
 ``NGLPointCollection`` or ``NGLPointCollection`` object. To access
 ...
 Learn how to add ``NGLPointAnnotation`` objects to your map.
 */
NGL_EXPORT
