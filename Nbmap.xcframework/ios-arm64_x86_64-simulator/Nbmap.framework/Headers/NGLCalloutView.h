...
@protocol NGLCalloutViewDelegate;
...
/**
 ...
 To receive updates from an object that conforms to the `NGLCalloutView` protocol,
 use the optional methods available in the `NGLCalloutViewDelegate` protocol.
 ...
 `NGLCalloutView`.
 */
@protocol NGLCalloutView <NSObject>

/**
 An object conforming to the `NGLAnnotation` protocol whose details this callout
 view displays.
 */
@property (nonatomic, strong) id <NGLAnnotation> representedObject;
...
/**
 An object conforming to the `NGLCalloutViewDelegate` method that receives
 messages related to the callout view’s interactive subviews.
 */
@property (nonatomic, weak) id<NGLCalloutViewDelegate> delegate;
...
/**
 ...
 `-[NGLCalloutView presentCalloutFromRect:inView:constrainedToRect:animated:]`
...
/**
 The `NGLCalloutViewDelegate` protocol defines a set of optional methods that
 you can use to receive messages from an object that conforms to the
 `NGLCalloutView` protocol. The callout view uses these methods to inform the
 delegate that the user has interacted with the the callout view.
 */
@protocol NGLCalloutViewDelegate <NSObject>
 ...
 */
- (BOOL)calloutViewShouldHighlight:(UIView<NGLCalloutView> *)calloutView;

/**
 Tells the delegate that the callout view has been tapped.
 */
- (void)calloutViewTapped:(UIView<NGLCalloutView> *)calloutView;

/**
 Called before the callout view appears on screen, or before the appearance
 animation will start.
 */
- (void)calloutViewWillAppear:(UIView<NGLCalloutView> *)calloutView;

/**
 Called after the callout view appears on screen, or after the appearance
 animation is complete.
 */
- (void)calloutViewDidAppear:(UIView<NGLCalloutView> *)calloutView;
