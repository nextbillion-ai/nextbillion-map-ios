 ...
 */
FOUNDATION_EXTERN NGL_EXPORT const NGLExpressionInterpolationMode
    NGLExpressionInterpolationModeLinear;
 ...
 */
FOUNDATION_EXTERN NGL_EXPORT const NGLExpressionInterpolationMode
    NGLExpressionInterpolationModeExponential;
...
/**
 Methods for creating expressions that use Nextbillion-specific functionality and for
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://docs.nextbillion.com/nextbillion-gl-js/style-spec/#accumulated"><code>id</code></a>
 expression operator in the MapLibre Style Spec.
 */
 ...
 */
+ (instancetype)ngl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate
                              trueExpression:(nonnull NSExpression *)trueExpression
                            falseExpresssion:(nonnull NSExpression *)falseExpression
    NS_SWIFT_NAME(init(forNGLConditional:trueExpression:falseExpression:));
 ...
 */
+ (instancetype)ngl_expressionForSteppingExpression:(nonnull NSExpression *)steppingExpression
                                     fromExpression:(nonnull NSExpression *)minimumExpression
                                              stops:(nonnull NSExpression *)stops
    NS_SWIFT_NAME(init(forNGLStepping:from:stops:));
...
/**
 ...
 #### Related examples
 TODO: Create a heatmap layer, learn how to style an ``NGLHeatmapStyleLayer``
 based on zoom level and point density with this expression.
 */
+ (instancetype)ngl_expressionForInterpolatingExpression:(nonnull NSExpression *)inputExpression
                                           withCurveType:
                                               (nonnull NGLExpressionInterpolationMode)curveType
                                              parameters:(nullable NSExpression *)parameters
                                                   stops:(nonnull NSExpression *)stops
    NS_SWIFT_NAME(init(forNGLInterpolating:curveType:parameters:stops:));
 ...
 */
+ (instancetype)ngl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression
                                       inDictionary:
                                           (nonnull NSDictionary<NSExpression *, NSExpression *> *)
                                               matchedExpressions
                                  defaultExpression:(nonnull NSExpression *)defaultExpression
    NS_SWIFT_NAME(init(forNGLMatchingKey:in:default:));
 ...
 */
+ (instancetype)ngl_expressionForAttributedExpressions:
 ...
 */
- (instancetype)ngl_expressionByAppendingExpression:(nonnull NSExpression *)expression
    NS_SWIFT_NAME(ngl_appending(_:));
