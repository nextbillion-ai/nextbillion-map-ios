...
typedef NS_ENUM(NSUInteger, NGLFillExtrusionTranslationAnchor) {
     ...
     */
    NGLFillExtrusionTranslationAnchorMap,
    /**
     The fill extrusion is translated relative to the viewport.
     */
    NGLFillExtrusionTranslationAnchorViewport,
};
 ...
 */
NGL_EXPORT
@interface NGLFillExtrusionStyleLayer : NGLVectorStyleLayer
...
*/
@property (nonatomic) NGLTransition fillExtrusionBaseTransition;
...
*/
@property (nonatomic) NGLTransition fillExtrusionColorTransition;
...
*/
@property (nonatomic) NGLTransition fillExtrusionHeightTransition;
...
*/
@property (nonatomic) NGLTransition fillExtrusionOpacityTransition;
...
*/
@property (nonatomic) NGLTransition fillExtrusionPatternTransition;
...
*/
@property (nonatomic) NGLTransition fillExtrusionTranslationTransition;
 ...
 * Constant `NGLFillExtrusionTranslationAnchor` values
