...
typedef NS_ENUM(NSUInteger, NGLFillTranslationAnchor) {
     ...
     */
    NGLFillTranslationAnchorMap,
    /**
     The fill is translated relative to the viewport.
     */
    NGLFillTranslationAnchorViewport,
};
 ...
 */
NGL_EXPORT
@interface NGLFillStyleLayer : NGLVectorStyleLayer
...
*/
@property (nonatomic) NGLTransition fillColorTransition;
...
*/
@property (nonatomic) NGLTransition fillOpacityTransition;
...
*/
@property (nonatomic) NGLTransition fillOutlineColorTransition;
...
*/
@property (nonatomic) NGLTransition fillPatternTransition;
...
*/
@property (nonatomic) NGLTransition fillTranslationTransition;
 ...
 * Constant `NGLFillTranslationAnchor` values
