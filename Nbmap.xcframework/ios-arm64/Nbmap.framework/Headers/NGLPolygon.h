...
/**
 ...
 ``NGLVectorTileSource``’s polygons collectively using an ``NGLVectorTileSource`` or
 ...
 an ``NGLMultiPolygon`` or ``NGLMultiPolygon`` object.
...
+ (instancetype)polygonWithCoordinates:(const CLLocationCoordinate2D *)coords
                                 count:(NSUInteger)count
                      interiorPolygons:(nullable NSArray<NGLPolygon *> *)interiorPolygons;
...
/**
 ...
 ``NGLVectorTileSource``’s multipolygons collectively using an ``NGLVectorTileSource``
