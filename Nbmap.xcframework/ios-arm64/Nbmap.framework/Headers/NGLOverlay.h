...
/**
 The `NGLOverlay` protocol defines a specific type of annotation that represents
 ...
 */
@protocol NGLOverlay <NGLAnnotation>
 ...
 */
@property (nonatomic, readonly) NGLCoordinateBounds overlayBounds;
 ...
 */
- (BOOL)intersectsOverlayBounds:(NGLCoordinateBounds)overlayBounds;
