...
/**
 ...
 let source = NGLImageSource(identifier: "radar", coordinateQuad: coordinates, url: URL(string:
 "https://maplibre.org/maplibre-gl-js-docs/assets/radar.gif")!) mapView.style?.addSource(source)
 ```

 #### Related examples
 TODO: Add an image, learn how to add an image to your map using ``NGLImageSource``.
 */
NGL_EXPORT
...
- (instancetype)initWithIdentifier:(NSString *)identifier
                    coordinateQuad:(NGLCoordinateQuad)coordinateQuad
                               URL:(NSURL *)url;
 ...
 */
- (void)setCoordinates:(NGLCoordinateQuad)coordinateQuad;
