...
typedef NS_ENUM(NSUInteger, NGLHillshadeIlluminationAnchor) {
     ...
     */
    NGLHillshadeIlluminationAnchorMap,
    /**
     The hillshade illumination is relative to the top of the viewport.
     */
    NGLHillshadeIlluminationAnchorViewport,
};
 ...
 */
NGL_EXPORT
@interface NGLHillshadeStyleLayer : NGLForegroundStyleLayer
...
*/
@property (nonatomic) NGLTransition hillshadeAccentColorTransition;
...
*/
@property (nonatomic) NGLTransition hillshadeExaggerationTransition;
...
*/
@property (nonatomic) NGLTransition hillshadeHighlightColorTransition;
 ...
 * Constant `NGLHillshadeIlluminationAnchor` values
...
/**
 ...
 `NGLHillshadeIlluminationAnchorViewport` and due north if
 `hillshadeIlluminationAnchor` is set to `NGLHillshadeIlluminationAnchorMap`.
...
*/
@property (nonatomic) NGLTransition hillshadeShadowColorTransition;
