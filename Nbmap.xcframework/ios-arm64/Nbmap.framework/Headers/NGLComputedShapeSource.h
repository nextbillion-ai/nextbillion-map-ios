...
/**
 ...
 clip ``NGLPolyline``s and ``NGLPolyline``s at tile boundaries without artifacts.
 ...
 */
- (NSArray<NGLShape<NGLFeature> *> *)featuresInTileAtX:(NSUInteger)x
                                                     y:(NSUInteger)y
...
/**
 ...
 @param zoomLevel Tile zoom level.
 */
- (NSArray<NGLShape<NGLFeature> *> *)featuresInCoordinateBounds:(NGLCoordinateBounds)bounds
                                                      zoomLevel:(NSUInteger)zoomLevel;
...
/**
 ...
 instances of ``NGLShape`` or ``NGLShape``, then add a computed shape source to an
 ``NGLStyle`` object along with an ``NGLStyle`` object. The vector style
 layer defines the appearance of any content supplied by the computed shape
 source.

 ``NGLComputedShapeSource`` is similar to ``NGLComputedShapeSource`` but is optimized for
 ...
 <a href="https://www.nextbillion.com/vector-tiles/">Nextbillion Vector Tiles</a>. For
 <a href="http://geojson.org/">GeoJSON</a> data, use the ``NGLShapeSource`` class.
 For static tiles or Nextbillion Vector Tiles, use the ``NGLVectorTileSource`` class.
...
/**
 ...
 ``NGLShapeSourceOptionMinimumZoomLevel``, ``NGLShapeSourceOptionMinimumZoomLevel``,
...
- (instancetype)initWithIdentifier:(NSString *)identifier
                           options:(nullable NSDictionary<NGLShapeSourceOption, id> *)options
...
/**
 ...
 @param identifier A string that uniquely identifies the source.
 @param dataSource An object conforming to NGLComputedShapeSourceDataSource protocol that will
 provide the shape data.
 @param options An `NSDictionary` of options for this source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                        dataSource:(id<NGLComputedShapeSourceDataSource>)dataSource
                           options:(nullable NSDictionary<NGLShapeSourceOption, id> *)options;
/**
...
/**
 ...
 @param zoomLevel Tile zoom level.
 */
- (void)setFeatures:(NSArray<NGLShape<NGLFeature> *> *)features
          inTileAtX:(NSUInteger)x
                  y:(NSUInteger)y
          zoomLevel:(NSUInteger)zoomLevel;

/**
 An object that implements the ``NGLComputedShapeSourceDataSource`` protocol that will be queried
 for tile data.
 */
