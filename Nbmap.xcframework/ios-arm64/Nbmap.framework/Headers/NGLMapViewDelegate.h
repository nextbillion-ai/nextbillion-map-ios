 ...
 */
@protocol NGLMapViewDelegate <NSObject>
 ...
 */
- (void)mapView:(NGLMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(NGLMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(NGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(NGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(NGLMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(NGLMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(NGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(NGLMapView *)mapView;
 ...
 */
- (void)mapViewWillStartLocatingUser:(NGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(NGLMapView *)mapView;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(NGLMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(NGLMapView *)mapView;
 ...
 */
- (CGFloat)mapView:(NGLMapView *)mapView alphaForShapeAnnotation:(NGLShape *)annotation;
 ...
 */
- (BOOL)mapView:(NGLMapView *)mapView shapeAnnotationIsEnabled:(NGLShape *)annotation;
 ...
 */
- (void)mapView:(NGLMapView *)mapView didSelectAnnotationView:(NGLAnnotationView *)annotationView;
