...
/**
 ...
 Learn how to cluster point data with this ``NGLShapeSourceOption``.
 */
...
/**
 ...
 is ignored when creating an ``NGLComputedShapeSource`` object.
 */
FOUNDATION_EXTERN NGL_EXPORT const NGLShapeSourceOption
...
/**
 ...
 Set this property to `YES` in order for the ``NGLLineStyleLayer/lineGradient`` property to have its
...
/**
 ...
 shown on the map. The shapes may be instances of ``NGLShape`` or ``NGLShape``,
 ...
 use the ``NGLComputedShapeSource`` or ``NGLComputedShapeSource`` class.
 ...
 TODO: Use images to cluster point data
 TODO: Add live data
 Learn how to add data to your map using this ``NGLSource`` object.
 */
NGL_EXPORT
...
/**
 ...
 subclass that conforms to the ``NGLFeature`` protocol, such as ``NGLFeature``.
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                          features:(NSArray<NGLShape<NGLFeature> *> *)features
                           options:(nullable NSDictionary<NGLShapeSourceOption, id> *)options;
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier
                            shapes:(NSArray<NGLShape *> *)shapes
                           options:(nullable NSDictionary<NGLShapeSourceOption, id> *)options;
...
/**
 ...
 @param cluster An object of type ``NGLPointFeatureCluster`` (that conforms to the
 ``NGLPointFeatureCluster`` protocol).
 @param offset Number of features to skip.
 @param limit The maximum number of features to return

 @return An array of objects that conform to the ``NGLFeature`` protocol.
 */
- (NSArray<id<NGLFeature>> *)leavesOfCluster:(NGLPointFeatureCluster *)cluster
...
/**
 ...
 the ``NGLCluster`` protocol (currently only objects of type ``NGLCluster``).
