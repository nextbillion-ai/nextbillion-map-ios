...
/** The font scale number expression relative to ``NGLSymbolStyleLayer/textFontSize`` used to format
 * the text. */
...
/**
 ...
 let attributes: [NGLAttributedExpressionKey: NSExpression] = [.fontNamesAttribute :
...
@property (strong, nonatomic, readonly)
    NSDictionary<NGLAttributedExpressionKey, NSExpression *> *attributes;
#else
/**
 The formatting attributes dictionary.
 Key | Value Type
...
/**
 Returns an ``NGLAttributedExpression`` object initialized with an expression and no attribute
 information.
 */
- (instancetype)initWithExpression:(NSExpression *)expression;

/**
 Returns an ``NGLAttributedExpression`` object initialized with an expression and text format
 attributes.
 */
- (instancetype)
    initWithExpression:(NSExpression *)expression
            attributes:(nonnull NSDictionary<NGLAttributedExpressionKey, NSExpression *> *)attrs;

/**
 Creates an ``NGLAttributedExpression`` object initialized with an expression and the format
