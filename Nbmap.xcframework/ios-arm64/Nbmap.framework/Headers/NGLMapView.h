...
FOUNDATION_EXTERN NGL_EXPORT const NGLMapViewDecelerationRate NGLMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
FOUNDATION_EXTERN NGL_EXPORT const NGLMapViewDecelerationRate NGLMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
FOUNDATION_EXTERN NGL_EXPORT const NGLMapViewDecelerationRate NGLMapViewDecelerationRateImmediate;
 ...
 */
@property (nonatomic, assign) NGLMapViewPreferredFramesPerSecond preferredFramesPerSecond;
 ...
 */
@property (nonatomic, null_resettable) id<NGLLocationManager> locationManager;
 ...
 */
@property (nonatomic, readonly, nullable) NGLUserLocation *userLocation;
 ...
 */
@property (nonatomic) NGLCoordinateBounds visibleCoordinateBounds;
 ...
 */
- (void)setVisibleCoordinateBounds:(NGLCoordinateBounds)bounds animated:(BOOL)animated;
 ...
 */
@property (nonatomic, copy) NGLMapCamera *camera;
...
/**
 ...
 @param completion The block to execute after the animation finishes.
 */
- (void)flyToCamera:(NGLMapCamera *)camera completionHandler:(nullable void (^)(void))completion;
 ...
 */
- (NGLCoordinateBounds)convertRect:(CGRect)rect toCoordinateBoundsFromView:(nullable UIView *)view;
...
/**
 ...
 @param view The view in whose coordinate system the returned rectangle should
    ...
    belong to the same window as the map view.
 */
- (CGRect)convertCoordinateBounds:(NGLCoordinateBounds)bounds toRectToView:(nullable UIView *)view;
